		...
		<div class="portfolio_slider_container">
			...
			<div class="portfolio_slider">
				...
				<div class="slider_item">
					...
					<div class="slider_item_background" style="background-image: url(../rango/images/portafolio/slider_nativos.png)"></div>
				</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 portfolio_title_container">
						...
						<h2 class="portfolio_title">Flyer para Nativos</h2>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 order-lg-1 order-2">
						<p class="portfolio_text">Foodtruck de comida venezolana. Nativos es un restaurante de comida rápida venezolana ubicado en el centro norte de la ciudad, en el sector Iñaquito, el cual solicito la creación de un flyer para presentar sus nuevos platos y aumentar la clientela.</p>
					</div>
					...
					<div class="col-lg-4 order-lg-3 order-1">
						<div class="portfolio_info_box">
							...
							<ul class="info_box_item">
								...
								<li class="info_box_content">Mayo 2018</li>
							</ul>
