		...
		<div class="portfolio_slider_container">
			...
			<div class="portfolio_slider">
				...
				<div class="slider_item">
					...
					<div class="slider_item_background" style="background-image: url(../rango/images/portafolio/slider_previfire_logo.png)"></div>
				</div>

				<!-- Slider Item -->
				<div class="slider_item">
					<!-- image by https://unsplash.com/@heysupersimi -->
					<div class="slider_item_background" style="background-image: url(../rango/images/portafolio/slider_previfire_logo_2.png)"></div>
				</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 portfolio_title_container">
						...
						<h2 class="portfolio_title">Logo para Previfire</h2>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 order-lg-1 order-2">
						<p class="portfolio_text">Local de seguridad industrial.  Previfire es un local de seguridad insutrial ubicado en el centro de la ciudad, en el sector la tola, el cual solicito la creación de un logo que los representara y distinguiera de sucompetencia, para ser usado en toda su publicidad.</p>
					</div>
					...
					<div class="col-lg-4 order-lg-3 order-1">
						<div class="portfolio_info_box">
							...
							<ul class="info_box_item">
								...
								<li class="info_box_content">Diciembre 2017</li>
							</ul>
